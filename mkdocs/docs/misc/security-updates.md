...
1. **Triage.** When you see a security alert, check the [issues list](https://github.com/hackforla/CivicTechJobs/issues?q=is%3Aissue+label%3Asecurity) and Dependabot's PRs to see if it's already being handled. If not, file an issue describing the vulnerability and link the GitHub alert. **[Q28]**
